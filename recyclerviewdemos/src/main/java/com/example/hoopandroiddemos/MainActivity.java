...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCustomRadioGroup = (RadioGroup) findViewById(R.id.custom_animation);
    ...
    private class RVAdapter extends RecyclerView.Adapter {
        ...
        private View.OnClickListener mItemAction = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                switch (mCustomRadioGroup.getCheckedRadioButtonId()) {
                    case R.id.custom_change:
                        mRecyclerView.setItemAnimator(mChangeAnimator);
                        break;
                    case R.id.custom_add_del:
                        mRecyclerView.setItemAnimator(new CustomAddDelAnimation());
